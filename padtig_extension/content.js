//변신 전
var $normalskilldesc = $("div.tooltip-body dl.skillinfo dl.normal dl.description dd");
if ($normalskilldesc.length) {
	...
	if(content.includes("변신")) {
		...
		$normalskilldesc.append("<a href='http://www.thisisgame.com/pad/info/monster/detail.php?code=" + num + "' class='yellowgreen'>" + name + "</a>");
		$normalskilldesc.append(content.substring(nameEndIndex, content.length));
	}
}

//변신 후
var $extradesc = $("div.tooltip-body dl.extradescription dd");
if ($extradesc.length) {
	...
	if($extradesc.text().includes("변신")) {
		...
		$extradesc.append("<a href='http://www.thisisgame.com/pad/info/monster/detail.php?code=" + num + "' class='yellowgreen'>" + name + "</a>");
